    ...
    <div className="w-full flex justify-center">
      ...
      <div className="max-w-[90%] w-full relative ">
        <Image
          ...
          width={1000}
          height={500}
          className=" transition duration-100 ease-in-out mx-auto rounded-lg object-cover w-[400px] sm:w-[500px] md:w-[600px] lg:w-[800px] xl:w-[1000px] z-0"
        />
        <div className="relative z-10 flex flex-col items-center -mt-24 sm:-mt-28 md:-mt-32 lg:-mt-36 xl:-mt-52">
          ...
          <Image
            ...
            width={300}
            height={750}
            className="shadow-md hover:scale-110 transition duration-300 ease-in-out rounded-lg object-cover mb-4 w-[200px] sm:w-[250px] md:w-[300px] lg:w-[350px] xl:w-[400px]"
          />
          <div className="max-w-5xl shadow-lg m-2 p-4 rounded-lg">
